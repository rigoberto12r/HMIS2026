...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("max_overbooking", sa.Integer, server_default=sa.text("0")),
        # BaseEntity
        sa.Column("is_active", sa.Boolean, server_default=sa.text("true"), nullable=False),
        sa.Column("deleted_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("created_by", postgresql.UUID(as_uuid=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("content_json", postgresql.JSONB, server_default=sa.text("\'{}\'::jsonb"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("current_sequence", sa.Integer, server_default=sa.text("0")),
    ...
    op.create_table(
        ...
        sa.Column("controlled_substance_level", sa.SmallInteger, server_default=sa.text("0")),
        sa.Column("requires_cold_chain", sa.Boolean, server_default=sa.text("false")),
        sa.Column("requires_prescription", sa.Boolean, server_default=sa.text("true")),
    ...
    op.create_table(
        ...
        sa.Column("quantity_reserved", sa.Integer, server_default=sa.text("0")),
    ...
    op.create_table(
        ...
        sa.Column("substitution_allowed", sa.Boolean, server_default=sa.text("true")),
        sa.Column("status", sa.String(20), server_default="'active'"),
    ...
    op.create_table(
        ...
        sa.Column("patient_verified", sa.Boolean, server_default=sa.text("false")),
        sa.Column("notes", sa.Text, nullable=True),
        # BaseEntity
        sa.Column("is_active", sa.Boolean, server_default=sa.text("true"), nullable=False),
        sa.Column("deleted_at", sa.DateTime(timezone=True), nullable=True),
